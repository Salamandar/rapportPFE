...
\section{Mesure du profil d'émission}
La mesure du profil spatial d'émission des pointes est permise, comme nous l'avions vu dans la première partie, par les platines piezoélectriques\footnote{Physik Instrumente PI P620}, grâce à leur déplacement sub-nanométrique et leur positionnement absolu. 

On utilise alors une pointe dont l'ouverture numérique est déjà connue, que l'on aligne devant la pointe dont on veut mesurer l'émission, et on la déplace tout en mesurant l'intensité reçue.

\begin{figure}[h]\centering
    \includegraphics[width=0.7\textwidth]{{"Images/Schemas/FibresScan"}}
    \caption{Schéma de scan des profils d'émission}
    \label{schema_fibre_scan}
\end{figure}

Il est à noter que le profil en transmission mesuré correspond à la convolution entre la pointe émettrice et la pointe réceptrice. La taille du spot mesurée doit alors être corrigée, et la largeur du faisceau, aussi appelée waist, est donnée par:
\[w = \sqrt{\tilde{w}^2 - w_0^2}
\] 
où $\tilde{w}$ est le waist mesuré et $w_0$ l'ouverture optique de la fibre de mesure.

Le waist de deux fibres identique est obtenu à partir de $w_{min}$, le waist minimal, mesuré avec les pointes au plus proche : $w_0 = w_{min}/\sqrt{2}$.
...
\begin{figure}[h]\centering
    \begin{subfigure}[b]{0.22\textwidth}
        \includegraphics[width=\textwidth]{{"Images/VarDistanceNues/Spot_small"}}
        \caption{}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.40\textwidth}
        \includegraphics[width=\textwidth]{{"Images/VarDistanceNues/DistanceNues"}}
        \caption{}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.22\textwidth}
        \includegraphics[width=\textwidth]{{"Images/VarDistanceNues/Spot_big"}}
        \caption{}
    \end{subfigure}
    \caption{Profils d'émission dans l'air (a,c) et évolution du waist avec la distance (b)}
    \label{nues_distance}
\end{figure}
...
\begin{figure}[h]\centering
    \begin{subfigure}[c]{0.156\textwidth}
        \includegraphics[width=\textwidth]{{"Images/VarDistanceNues/Metal_50nm"}.png}
        \caption*{$d = 50nm$}
    \end{subfigure}
    ...
    \end{subfigure}
    \begin{subfigure}[c]{0.156\textwidth}
        \includegraphics[width=\textwidth]{{"Images/VarDistanceNues/Metal_1um"}.png}
        \caption*{$d = 1\mu m$}
    \end{subfigure}
...
\section{Influence de la polarisation incidente sur l'émission}\label{sec:polarisation}
